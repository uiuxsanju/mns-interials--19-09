...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aarambh Interiors — Full Home Interior Design" },
      {
        name: "description",
        content:
          "Aarambh Interiors designs and builds full home interiors, modular kitchens and wardrobes with fixed pricing and on-time handover.",
      },
      { name: "author", content: "Aarambh Interiors" },
